<template>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="backendTheme/assets/img/profile-img.jpg" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2">{{userDetails.name }}</span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
                <button class="dropdown-item d-flex align-items-center" type="button" @click="logout()"> <i class="bi bi-box-arrow-up"></i>Sign Out</button>
            </li>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item" v-if="$can($constants.permissions.viewUserRolePermissionManagement)">
     ...
     <li class="nav-item" v-if="$can($constants.permissions.viewInviteLink)">  
       ...
       <li class="nav-item" v-if="$can($constants.permissions.viewPmsMaster)">
        ...
        <router-link :to="{name:'pmsattribute'}" class="nav-link collapsed" >
          <i class="bi bi-person"></i>
...
<!-- componente render Here means change here End-->
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>{{webInfo.company_name}}</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      Designed by <a :href="webInfo.company_website" target="_blank">{{webInfo.company_name}}</a>
    </div>
  </footer><!-- End Footer -->
   ...
   export default{
    ...
    Notification
      ...
      data(){
   	...
   	computed : {
        ...mapGetters(
          {userDetails :"getUserDetails",webInfo:"getWebDetails"},
        ),
