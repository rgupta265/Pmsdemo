            ...
            <div class="card-body py-2">
              <strong
                ...
                <span
                  ...
                  {{ resultInfo.total ? resultInfo.total : 0 }} Report
                </span>
              </strong>
        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="card table-responsive">
              <div class="card-body">
                <h5 class="card-title">PMS Report List</h5>
...
export default {
  ...
  computed: {
    filteredReportList() {
      return this.reportList.filter((reportDemo) => {
        return (
          reportDemo.emp_code
            .toLowerCase()
            .includes(this.reportSearch.toLowerCase()) ||
          reportDemo.report_id
            .toLowerCase()
            .includes(this.reportSearch.toLowerCase()) ||
          reportDemo.report_cycle
            .toLowerCase()
            .includes(this.reportSearch.toLowerCase()) ||
          reportDemo.report_duration_from
            .toLowerCase()
            .includes(this.reportSearch.toLowerCase()) ||
          reportDemo.report_duration_to
            .toLowerCase()
            .includes(this.reportSearch.toLowerCase()) ||
          reportDemo.user_report_info.email
            .toLowerCase()
            .includes(this.reportSearch.toLowerCase()) ||
          reportDemo.user_report_info.name
            .toLowerCase()
            .includes(this.reportSearch.toLowerCase())
        );
      });
