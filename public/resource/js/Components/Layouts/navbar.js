...
var render = function render() {
  ...
  }, [_vm._v(" " + _vm._s(_vm.notifications.length))])]), _vm._v(" "), _c("Notification")], 1), _vm._v(" "), _c("li", {
  ...
  }), _vm._v(" "), _c("span", [_vm._v("Invite Link")])])], 1) : _vm._e(), _vm._v(" "), _vm.$can(_vm.$constants.permissions.viewMyReport) ? _c("li", {
    staticClass: "nav-item"
  }, [_c("router-link", {
    staticClass: "nav-link",
    attrs: {
...
var render = function render() {
  ...
  return _c("ul", {
    ...
    staticClass: "dropdown-header"
  }, [_vm._v("\n    You have " + _vm._s(_vm.notifications.length) + " new notifications\n    "), _vm._m(0)]), _vm._v(" "), _vm._l(_vm.notifications, function (notify, index) {
    return _c("div", {
      key: index,
