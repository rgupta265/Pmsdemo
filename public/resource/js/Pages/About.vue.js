...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_2__["mapActions"])(["ChangePassword"])), {}, {
    ...
    saveData: function saveData() {
      ...
      axios.post('userdetail', this.user, formData).then(function (response) {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.user.emp_code,
      expression: "user.emp_code"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text"
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.user, "emp_code", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "row mb-3"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.user.father_name,
      expression: "user.father_name"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.user, "father_name", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "row mb-3"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.user.correspondence_address,
      expression: "user.correspondence_address"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.user, "correspondence_address", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "row mb-3"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.user.emergency_contactno,
      expression: "user.emergency_contactno"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text"
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.user, "emergency_contactno", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "row mb-3"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.user.linkedin_id,
      expression: "user.linkedin_id"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.user, "linkedin_id", $event.target.value);
      }
    }
...
var staticRenderFns = [function () {
  ...
  }, [_vm._v("Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.")])])]);
}, function () {
  var _vm = this,
      _c = _vm._self._c;
